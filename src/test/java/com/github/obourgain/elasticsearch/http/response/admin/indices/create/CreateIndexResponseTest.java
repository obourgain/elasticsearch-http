...
public class CreateIndexResponseTest {
    ...
    public void should_parse_succes() {
        ...
        CreateIndexResponse response = new CreateIndexResponse().doParse(new BytesArray(json), 200);
    ...
    public void should_parse_failure() {
        String json = "{\n" +
                ...
                "   \"status\": 400\n" +
                "}";
        CreateIndexResponse response = new CreateIndexResponse().doParse(new BytesArray(json), 400);
