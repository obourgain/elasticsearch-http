...
public class PercentileRanks extends AbtractAggregation {
    ...
    public static PercentileRanks parse(XContentParser parser, String name) {
        try {
            PercentileRanks range = new PercentileRanks(name);
