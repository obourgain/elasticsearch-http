package com.github.obourgain.elasticsearch.http.response.suggest;
...
public class SuggestParser {
    ...
    public static Map<String, AggregationMetaInfos> parseQuery(SuggestRequest request) {
        try {
            XContentParser parser = XContentHelper.createParser(SuggestRequestAccessor.getSource(request));
