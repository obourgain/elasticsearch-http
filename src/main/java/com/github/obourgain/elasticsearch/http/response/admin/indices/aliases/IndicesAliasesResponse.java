...
public class IndicesAliasesResponse {
    ...
    public static Observable<IndicesAliasesResponse> parse(ByteBuf content, int status) {
        return Observable.just(new IndicesAliasesResponse().doParse(new ByteBufBytesReference(content), status));
    }

    private IndicesAliasesResponse doParse(BytesReference bytesReference, int status) {
