...
public class DateHistogram extends AbtractAggregation {
    ...
    public static DateHistogram parse(XContentParser parser, String name) {
        try {
            DateHistogram range = new DateHistogram(name);
